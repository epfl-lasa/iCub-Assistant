...
[Salman Faraji](https://salmanfaraji.github.io/) for instructions to generate the library. Once generated place the code in `~./iCub-Assistant/dependencies/IKCG_cvxgen/`.
...
[Salman Faraji](https://salmanfaraji.github.io/) for instructions on how to generate this model once you have acquired SDFast. Once generated place the code in `~./iCub-Assistant/dependencies/sdfast/`.
