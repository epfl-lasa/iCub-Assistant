...
- The code for the IK solver (described in Section II of [1]) is generated by [CVXGEN](https://cvxgen.com/docs/index.html) as we cannot distribute it under any license, please contact [Nadia Figueroa](http://lasa.epfl.ch/people/member.php?SCIPER=238387) or 
[Salman Faraji](https://salmanfaraji.github.io/) for instructions to generate the library and place in `~./iCub-Assistant/dependencies/`.
